...
class BlogSidebar2 extends React.Component {
                    ...
                    <aside className="side-bar">
                        ...
                        <div className="widget bg-white">
                            ...
                            <div className="widget-post m-b15">
                                <img src={require("./../../images/gallery/portrait/pic3.jpg").default} alt="" className="img-responsive" />
                            </div>
                        ...
                        <div className="widget">
                            <h4 className="widget-title  text-uppercase">Brands we Work</h4>

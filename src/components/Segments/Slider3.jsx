            ...
            <div>
                <div id="rev_slider_346_1_wrapper" className="rev_slider_wrapper fullscreen-container" data-alias="beforeafterslider1" data-source="gallery" style={{ background: '#252525', padding: 0 }}>
                    ...
                    <div className="tp-caption   tp-resizeme rs-parallaxlevel-5" 
                        ...
                        style={{ zIndex: 11, minWidth: 960, maxWidth: 960, whiteSpace: 'normal', fontWeight: 700, color: '#fb0c1d', letterSpacing: 5, fontFamily: 'Montserrat', textTransform: 'uppercase' }}>TRANSFORMING HOMES INTO WORKS OF ART</div>
                    ...
                    <div className="tp-caption   tp-resizeme rs-parallaxlevel-5" 
                        ...
                        style={{ zIndex: 17, minWidth: 960, maxWidth: 960, whiteSpace: 'normal', fontWeight: 700, color: '#e4e4e0', letterSpacing: 5, fontFamily: 'Montserrat', textTransform: 'uppercase' }}>TRANSFORMING HOMES INTO WORKS OF ART</div>
                    ...
                    <div className="tp-caption   tp-resizeme rs-parallaxlevel-4" 
                        ...
                        style={{ zIndex: 18, whiteSpace: 'nowrap', fontSize: 15,lineHeight:60, fontWeight: 700, color: '#fff', letterSpacing: 5, fontFamily: 'Montserrat', backgroundColor: '#fb0c1d', cursor: 'pointer' }}>
                            <NavLink to={"#"} title="MAKE A CHOICE" rel="bookmark">MAKE A CHOICE</NavLink>
                        </div>
                                </li>
                                {/* SLIDE 1 */}
